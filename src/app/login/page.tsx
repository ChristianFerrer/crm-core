      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="bg-surface border border-line rounded-2xl p-6 space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-xl border border-line bg-surface2 py-3 text-sm font-semibold text-snow hover:border-line2 transition-colors"
          >
        ...
        <p className="text-center text-[10px] text-mist">Watermelon CRM · v0.1</p>
      </div>
    </div>
  )
}
