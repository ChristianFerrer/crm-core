...
export default async function DashboardPage({
  ...
  const [
    ...
    supabase
      .from('bookings')
      .select('id, type, title, date, start_time, end_time, guests, guest_adults, guest_children, child_name, notes, executed_at, member_id, amount, deposit_amount, payment_status, status, addons, members(name), services(name)')
      .eq('date', selectedDate)
