...
export default async function DashboardPage({
  ...
  const [
    ...
    supabase
      .from('visits')
      .select('id, checked_in_at, checked_out_at, member_id, membership_id, visit_type, children_present, adults_count, children_count, booking_id, members(name), memberships(sessions_remaining, membership_types(name, sessions, price)), bookings(type)')
