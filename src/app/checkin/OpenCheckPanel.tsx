      ...
      {pickProduct && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-xs rounded-2xl border border-line bg-surface p-5 space-y-4">
            ...
            <button onClick={confirmAdd} className="w-full rounded-xl border border-lime bg-lime/10 py-3 text-sm font-semibold text-lime hover:bg-lime/20 transition-colors flex items-center justify-center gap-2">
