export const dictPanelResumen = {
  panelres_titulo: { es: 'Resumen', en: 'Summary', ca: 'Resum', de: 'Übersicht' },
  panelres_alertas_activas: { es: 'Alertas activas', en: 'Active alerts', ca: 'Alertes actives', de: 'Aktive Warnungen' },
  panelres_todas_cerradas: { es: 'Todas las alertas cerradas', en: 'All alerts dismissed', ca: 'Totes les alertes tancades', de: 'Alle Warnungen erledigt' },
  panelres_alerta_bono_1: { es: '{name} — le queda solo 1 sesión de bono', en: '{name} — only 1 pass session left', ca: '{name} — només li queda 1 sessió de bo', de: '{name} — hat nur noch 1 Sitzung im Guthaben' },
