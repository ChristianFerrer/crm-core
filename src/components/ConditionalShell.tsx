...
export function ConditionalShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      {viewingAs && (
        <div className="fixed top-14 lg:top-0 left-0 right-0 z-50 flex items-center justify-between gap-3 bg-amber/10 border-b border-amber/30 px-4 py-2 lg:pl-60">
      ...
      <AppShell>
        <main className={`pb-20 lg:pb-0 px-4 lg:px-8 lg:pt-8 max-w-2xl lg:max-w-none ${viewingAs ? 'pt-24 lg:pt-4' : 'pt-16 lg:pt-4'}`}>
          {children}
        </main>
      </AppShell>
      <BottomNav />
