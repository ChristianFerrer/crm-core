...
function Badge({ count }: { count: number }) {
  ...
  return (
    <span className="ml-auto min-w-[18px] h-[18px] px-1 rounded-full bg-lime text-white text-[10px] font-bold flex items-center justify-center leading-none shrink-0">
      {count > 99 ? '99+' : count}
    </span>
  )
}
